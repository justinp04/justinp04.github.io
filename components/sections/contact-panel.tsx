...
export function ContactPanel({
  ...
  return (
    <section
      ...
      className="rounded-2xl border border-border bg-surface p-6 shadow-2xl shadow-black/20 sm:p-10"
      id="contact"
    >
      ...
      <p aria-live="polite" className="mt-4 min-h-6 text-sm text-primary" role="status">
        {status}
      </p>
    </section>
  );
